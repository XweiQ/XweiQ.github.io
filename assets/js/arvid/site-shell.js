...
(function() {
  ...
  const FOOTER_SOCIALS = [
    ...
    {
      href: 'https://scholar.google.com/citations?user=OZDAmwoAAAAJ',
  ...
  function getFooterCopy() {
    ...
    if (getCurrentPage() === 'photography') {
      return '© 2026 Xiaowei Qian. All photographs are original works.';
    }

    return '© 2026 Xiaowei Qian';
  }
  ...
  <nav class="nav-buttons" role="navigation" aria-label="Main navigation">
    ${navLinks}
    <!-- Dark mode temporarily disabled; uncomment together with initializeDarkMode() in both layouts.
